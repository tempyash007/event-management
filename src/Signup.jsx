      ...
      <div className="w-[95%] sm:w-full md:max-w-md p-6 md:p-8 space-y-6 bg-[#1a1a1a] rounded-[2rem] border border-gray-800 shadow-2xl">
        ...
        <div className="flex gap-4">
          ...
          >
            ...
            <span className="font-semibold text-sm text-gray-300 group-hover:text-white">Sign Up with Google</span>
          </button>
        </div>
        ...
        <p className="text-center text-xs text-gray-500 leading-relaxed">
          Want to host events?{' '}
          <Link to="/organizer-signup" className="text-white font-medium hover:underline">
